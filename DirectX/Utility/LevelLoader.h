...
public:
    ...
    static bool getVector3Array(const rapidjson::Value& inObject, const char* inProperty, std::vector<Vector3>& out);
    ...
    static void setVector3Array(rapidjson::Document::AllocatorType& alloc, rapidjson::Value& inObject, const char* name, const std::vector<Vector3>& values);
};
